...
class MahasiswaController extends BaseController
{
    ...
    public function index(Request $request): View
    {
        ...
        if ($sort === 'nim') {
            $mahasiswas = $this->mahasiswaService->sortByNim($mahasiswas);
        } elseif ($sort === 'nama') {
            $mahasiswas = $this->mahasiswaService->bubbleSortByNama($mahasiswas);
        } elseif ($sort === 'ipk') {
            $mahasiswas = $this->mahasiswaService->sortByIpk($mahasiswas);
        } elseif ($sort === 'jurusan') {
            $mahasiswas = $this->mahasiswaService->sortByJurusan($mahasiswas);
        } elseif ($sort === 'email') {
            $mahasiswas = $this->mahasiswaService->sortByEmail($mahasiswas);
        }

        return view('Mahasiswa.index', compact('mahasiswas', 'keyword', 'sort'));
    }
