...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; margin: 0; padding: 1.5rem; min-height: 100vh; background: url('{{ asset('background.jpg') }}') center/cover no-repeat; background-color: #eef2ff; color: #1f2937; }
    ...
    <div class="card">
        ...
        <form action="{{ route('mahasiswa.store') }}" method="POST">
            ...
            <div class="field">
                ...
                <input id="jurusan" name="jurusan" value="{{ old('jurusan') }}" required>
            </div>
            <div class="field">
                <label for="ipk">IPK</label>
                <input id="ipk" name="ipk" type="number" step="0.01" min="0" max="4" value="{{ old('ipk') }}" required>
            </div>
            <div class="field">
