...
<head>
    ...
    <title>Edit Mahasiswa - SIMA</title>
    <style>
        /* Base & CSS Background */
        body { 
        ...
        <div class="card">
            ...
            <form action="{{ route('mahasiswa.update', $mahasiswa->getNim()) }}" method="POST">
                ...
                <div class="field">
                    ...
                    <input id="nim" name="nim" value="{{ old('nim', $mahasiswa->getNim()) }}" required>
                </div>
                <div class="field">
                    <label for="nama">Nama Lengkap</label>
                    <input id="nama" name="nama" value="{{ old('nama', $mahasiswa->getNama()) }}" required>
                </div>
                <div class="field">
                    <label for="jurusan">Jurusan</label>
                    <input id="jurusan" name="jurusan" value="{{ old('jurusan', $mahasiswa->getJurusan()) }}" required>
                </div>
                <div class="field">
                    <label for="ipk">IPK</label>
                    <input id="ipk" name="ipk" type="number" step="0.01" min="0" max="4" value="{{ old('ipk', $mahasiswa->getIpk()) }}" required>
                </div>
                <div class="field">
                    <label for="email">Email</label>
                    <input id="email" name="email" type="email" value="{{ old('email', $mahasiswa->getEmail()) }}" required>
                </div>
                <div class="field">
                    <label for="no_hp">No. HP</label>
                    <input id="no_hp" name="no_hp" value="{{ old('no_hp', $mahasiswa->getNoHp()) }}" required>
                </div>
                <div class="actions">
