            ...
            <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:1.5rem;">
                <div>
                    <h1 style="margin:0 0 0.5rem 0; font-size:2rem; font-weight: 700;">Selamat Datang,
                        <?php echo e(ucfirst(session('username', 'admin'))); ?>!</h1>
                ...
                <div class="card filter-card">
                    <form method="GET" action="<?php echo e(route('mahasiswa.index')); ?>">
                            ...
                            <div class="filter-section">
                                ...
                                <div class="filter-row">
                                    ...
                                    <select name="search_type" class="form-select">
                                        <option value="linear" <?php echo e($search_type === 'linear' ? 'selected' : ''); ?>>Linear
                                            Search (Nama/Jurusan)</option>
                                        <option value="binary" <?php echo e($search_type === 'binary' ? 'selected' : ''); ?>>Binary
                                            Search (NIM)</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="filter-section" style="margin-top: 0.5rem;">
                                ...
                                <div class="filter-row">
                                    <select name="sort_field" class="form-select">
                                        ...
                                        <option value="nim" <?php echo e($sort_field === 'nim' ? 'selected' : ''); ?>>NIM
                                        </option>
                                        <option value="nama" <?php echo e($sort_field === 'nama' ? 'selected' : ''); ?>>Nama
                                            Mahasiswa</option>
                                        <option value="jurusan" <?php echo e($sort_field === 'jurusan' ? 'selected' : ''); ?>>
                                            Jurusan</option>
                                        <option value="ipk" <?php echo e($sort_field === 'ipk' ? 'selected' : ''); ?>>IPK
                                        </option>
                                        <option value="email" <?php echo e($sort_field === 'email' ? 'selected' : ''); ?>>Email
                                        </option>
                                    </select>
                                    <select name="sort_algo" class="form-select" style="margin-top: 0.5rem;">
                                        <option value="bubble" <?php echo e($sort_algo === 'bubble' ? 'selected' : ''); ?>>Bubble
                                            Sort</option>
                                        <option value="selection" <?php echo e($sort_algo === 'selection' ? 'selected' : ''); ?>>
                                            Selection Sort</option>
                                        <option value="quick" <?php echo e($sort_algo === 'quick' ? 'selected' : ''); ?>>Quick
                        ...
                        <div class="filter-actions-row" style="margin-top: 1.25rem; display: flex; flex-direction: column; gap: 0.5rem; width: 100%; box-sizing: border-box;">
                            ...
                            <a href="<?php echo e(route('mahasiswa.index')); ?>" style="width: 100%; box-sizing: border-box; padding: 0.75rem 1rem; border-radius: 0.5rem; font-weight: 500; font-size: 0.875rem; text-align: center; text-decoration: none; cursor: pointer; background-color: #f1f5f9; color: #475569; border: 1px solid #cbd5e1; display: block;">Reset</a>
                        </div>
                    </form>
                </div>
                ...
                <div class="card" style="padding: 1.75rem;">
                    <div
                        ...
                        <div style="display:flex; gap:0.75rem; align-items:center; flex-wrap:wrap;">
                            <a href="<?php echo e(route('mahasiswa.create')); ?>" class="btn btn-primary-custom"
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $mahasiswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="m-card">
                                ...
                                <div class="m-card-actions">
                                    ...
                                    <form action="<?php echo e(route('mahasiswa.destroy', $m->getNim())); ?>" method="POST"
