        ...
        <div class="card">
            ...
            <form action="<?php echo e(route('mahasiswa.store')); ?>" method="POST">
                ...
                <div class="field">
                    ...
                    <input id="nim" name="nim" value="<?php echo e(old('nim')); ?>" placeholder="Masukkan NIM" required>
                </div>
                <div class="field">
                    <label for="nama">Nama Lengkap</label>
                    <input id="nama" name="nama" value="<?php echo e(old('nama')); ?>" placeholder="Masukkan Nama Lengkap" required>
                </div>
                <div class="field">
                    <label for="jurusan">Jurusan</label>
                    <input id="jurusan" name="jurusan" value="<?php echo e(old('jurusan')); ?>" placeholder="Masukkan Jurusan" required>
                </div>
                <div class="field">
                    <label for="ipk">IPK</label>
                    <input id="ipk" name="ipk" type="number" step="0.01" min="0" max="4" value="<?php echo e(old('ipk')); ?>" placeholder="Contoh: 3.75" required>
                </div>
                <div class="field">
                    <label for="email">Email</label>
                    <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" placeholder="Masukkan Alamat Email" required>
                </div>
                <div class="field">
                    <label for="no_hp">No. HP</label>
                    <input id="no_hp" name="no_hp" value="<?php echo e(old('no_hp')); ?>" placeholder="Masukkan Nomor HP" required>
                </div>
                <div class="actions">
...
<?php /**PATH D:\Herd\management-students\resources\views/Mahasiswa/create.blade.php ENDPATH**/ ?>