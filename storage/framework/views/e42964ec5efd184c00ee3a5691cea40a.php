...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; background: url('<?php echo e(asset('background.jpg')); ?>') center/cover no-repeat; background-color: #eef2ff; display: flex; align-items: center; justify-content: center; min-height: 100vh; margin: 0; padding: 1rem; }
...
<body>
    <div class="card">
        <div class="logo-wrapper">
            <img src="<?php echo e(asset('login-logo.png')); ?>" alt="Logo UNPAM" class="logo">
        </div>
        <h1>Login</h1>
        <p>Silakan masuk untuk mengakses data mahasiswa.</p>

        <?php if(session('status')): ?>
            <div class="error" style="color: #047857;"><?php echo e(session('status')); ?></div>
        <?php endif; ?>
        ...
        <div style="margin-top: 1rem; text-align: center;">
            <a href="<?php echo e(route('password.reset')); ?>">Reset Password</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\zidan\Documents\college\Semester 3\algoritma\project\manajemen-mahasiswa\resources\views/auth/login.blade.php ENDPATH**/ ?>